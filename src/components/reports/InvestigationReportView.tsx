...
<head>
  ...
  <title>Maritime Oil Spill Intelligence Report - ${currentIncident.incidentCode}</title>
  <style>
    :root {
      --primary: #0284c7;
      --primary-dark: #0369a1;
...
<body>
  <div class="container">
    ...
    <div class="header">
      <div>
        <div class="brand-title">Maritime Oil Spill Intelligence</div>
        <div class="tagline">AI Oil Spill Detection & Vessel Attribution Platform</div>
    ...
    downloadAnchor.download = `Maritime_Oil_Spill_Intelligence_Report_${currentIncident.incidentCode}.html`;
        ...
        <div className="border-b-2 border-neutral-800 print:border-slate-300 pb-6 flex items-start justify-between">
          <div className="space-y-1">
            ...
            <p className="text-xs text-neutral-400 print:text-slate-600">
              AI Oil Spill Detection & Vessel Attribution Platform
            </p>
          </div>
